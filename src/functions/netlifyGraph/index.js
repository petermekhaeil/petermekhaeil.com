...
const operationsDoc = `query CommittedDate($name: String = "til", $owner: String = "petermekhaeil", $path: String) @netlify(id: """bf6a0187-9d02-4f29-8975-904c66874bf4""", doc: """Get committed date of path from repository.""") {
  gitHub {
...
exports.fetchCommittedDate = (
      variables,
      options
    ) => {
      return fetchNetlifyGraph({
        query: operationsDoc,
        operationName: "CommittedDate",
        variables: variables,
        options: options || {},
      });
    }
...
const functions = {
  ...
  */
  fetchCommittedDate: exports.fetchCommittedDate,
  /**
